...
> 11개 Area와 N개 Stage 매핑 (기본 5개, 동적 확장 가능)
...
| S1F1 | S2BA1 | ❌ | Stage 2 > Stage 1 (역방향) |
| S1F2 | S1F1 | ⚠️ | 같은 Stage (허용되나 병렬성 감소) |
